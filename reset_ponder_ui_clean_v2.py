...
if p.exists():
    p.with_suffix(".js.bak_before_clean_v2").write_text(p.read_text())
...
window.addEventListener("load", function () {
  ...
  if (!document.getElementById("ppSettingsButton")) {
    ...
    panel.innerHTML = "<h3>🐾 Ponder Pro Settings</h3><p>Focus Mode: Ready</p><p>Colorblind Mode: Icons + labels</p><p>Theme: Default</p>";
...
print("✅ Rebuilt static/ponder_ui.js cleanly")
