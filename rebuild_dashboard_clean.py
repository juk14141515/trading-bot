...
backup = Path(f"web_dashboard_broken_backup_{datetime.now().strftime('%Y%m%d_%H%M%S')}.py")
...
<div class="footer">Ponder Invest AI · Adaptive cloud trading dashboard · <a href="/logout" style="color:#94a3b8;">Logout</a></div>
</div>
...
print("✅ Clean dashboard rebuilt using templates")
print(f"✅ Broken file backed up as: {backup}")
print("Now run:")
